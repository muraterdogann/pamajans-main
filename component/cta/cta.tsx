						...
						<div className="items-center justify-between md:flex">
							<div className="mb-6 md:w-1/2">
								<h2 className="mb-4 font-display text-2xl text-jacarta-700 dark:text-white sm:text-3xl">
									Mutlu markalarımızın arasına katılın
								</h2>
								<p className="mb-8 text-lg ">
								Markanızın potansiyelini ortaya çıkaralım ve büyüme hedeflerine ulaşmanızı sağlayacak stratejiler sunalım. İletişime geçin, başarının kapılarını birlikte açalım.
								</p>
