    ...
    >
      ...
      <div className="mt-10 w-full lg:hidden">
        ...
        <div className="flex items-center justify-center space-x-5">
          <a className="group" target="_blank" href="https://www.facebook.com/pamajans/?locale=tr_TR">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a className="group" target="_blank" href="https://www.instagram.com/pamajans/">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a className="group" href="https://www.tiktok.com/@pamajans" target="_blank">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
